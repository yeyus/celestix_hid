...
COBJS     = hid.o celestix_lcd.o
CPPOBJS   = hidtest.o
OBJS      = $(COBJS) $(CPPOBJS)
LIBS_UDEV = `pkg-config libudev --libs` -lrt
LIBS      = $(LIBS_UDEV)
INCLUDES ?= -I/usr/include/hidapi -I. `pkg-config libusb-1.0 --cflags`
...
clean:
	rm -f $(OBJS) hidtest-hidraw libhidapi-hidraw.so hidtest.o celestix_lcd.o
